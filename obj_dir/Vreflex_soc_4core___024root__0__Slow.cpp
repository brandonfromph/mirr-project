...
VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_static(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_static\n"); );
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_initial__TOP(Vreflex_soc_4core___024root* vlSelf);

VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_initial(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_initial\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    Vreflex_soc_4core___024root___eval_initial__TOP(vlSelf);
}

VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_initial__TOP(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_initial__TOP\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_final(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_final\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
}

#ifdef VL_DEBUG
VL_ATTR_COLD void Vreflex_soc_4core___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag);
#endif  // VL_DEBUG
VL_ATTR_COLD bool Vreflex_soc_4core___024root___eval_phase__stl(Vreflex_soc_4core___024root* vlSelf);

VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_settle(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_settle\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    ...
    do {
...
#ifdef VL_DEBUG
            Vreflex_soc_4core___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
#endif
        ...
        vlSelfRef.__VstlPhaseResult = Vreflex_soc_4core___024root___eval_phase__stl(vlSelf);
        vlSelfRef.__VstlFirstIteration = 0U;
    } while (vlSelfRef.__VstlPhaseResult);
}

VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_triggers_vec__stl(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_triggers_vec__stl\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vreflex_soc_4core___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in);

#ifdef VL_DEBUG
VL_ATTR_COLD void Vreflex_soc_4core___024root___dump_triggers__stl(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___dump_triggers__stl\n"); );
    // Body
    if ((1U & (~ (IData)(Vreflex_soc_4core___024root___trigger_anySet__stl(triggers))))) {
...
VL_ATTR_COLD bool Vreflex_soc_4core___024root___trigger_anySet__stl(const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___trigger_anySet__stl\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___stl_sequent__TOP__0(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___stl_sequent__TOP__0\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___eval_stl(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_stl\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD bool Vreflex_soc_4core___024root___eval_phase__stl(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___eval_phase__stl\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    CData/*0:0*/ __VstlExecute;
    // Body
    Vreflex_soc_4core___024root___eval_triggers_vec__stl(vlSelf);
#ifdef VL_DEBUG
    if (VL_UNLIKELY(vlSymsp->_vm_contextp__->debug())) {
        Vreflex_soc_4core___024root___dump_triggers__stl(vlSelfRef.__VstlTriggered, "stl"s);
    }
#endif
    __VstlExecute = Vreflex_soc_4core___024root___trigger_anySet__stl(vlSelfRef.__VstlTriggered);
    if (__VstlExecute) {
        Vreflex_soc_4core___024root___eval_stl(vlSelf);
    }
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___dump_triggers__act\n"); );
    // Body
    if ((1U & (~ (IData)(Vreflex_soc_4core___024root___trigger_anySet__act(triggers))))) {
        VL_DBG_MSGS("         No '" + tag + "' region triggers active\n");
    }
    if ((1U & (IData)(triggers[0U]))) {
...
VL_ATTR_COLD void Vreflex_soc_4core___024root___ctor_var_reset(Vreflex_soc_4core___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vreflex_soc_4core___024root___ctor_var_reset\n"); );
    Vreflex_soc_4core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body

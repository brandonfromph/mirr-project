...
use mirrc::ast::types::{packet_type, surface_type, EffectQualifier, Linearity, SignalType};
...
#[test]
fn format_fifo() {
    let fifo = SignalType::Fifo { element: Box::new(SignalType::Unsigned(8)), depth: 16 };

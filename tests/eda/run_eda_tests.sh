#!/usr/bin/env bash
# MIRR EDA Test Suite — 105 tests using oss-cad-suite
...
# Does NOT require cargo — fully standalone
...
for tool in yosys iverilog vvp sby; do
    if command -v "$tool" &>/dev/null; then
        ...
        echo "NOTE: $tool not found in PATH — related tests will be skipped"
    fi
done
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 1: Yosys Parse (20 tests) ──"
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 2: Yosys Synthesis ice40 (20 tests) ──"
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 3: Yosys Lint/Check (15 tests) ──"
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 4: iverilog Compile (20 tests) ──"
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 5: iverilog+vvp Simulation (20 tests) ──"
...
# ═══════════════════════════════════════════════════════════════════
echo ""
echo "── Category 6: SymbiYosys Formal (10 tests) ──"
